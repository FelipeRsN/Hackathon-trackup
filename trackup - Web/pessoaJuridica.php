...
<ul class="collapsible" data-collapsible="accordion">
    <li>
        <div class="collapsible-header"><i class="material-icons">store</i>Dados da Empresa</div>
        <div class="collapsible-body">
            <p>Razão Social: <?= $nome = "Tantufa LTDA" ?></p>
            <p>Data Abertura: <?= $sexo = "04/02/2015" ?></p>
            <p>Cnpj: <?= $idade = "377.877.988/0001-00" ?></p>
        </div>
    </li>
    <li>
        <div class="collapsible-header"><i class="material-icons">assignment_ind</i>Sócio 1</div>
        <div class="collapsible-body">
            <p>Nome: <?= $nome ?></p>
            <p>Sexo: <?= $sexo ?></p>
            <p>Idade: <?= $idade ?></p>
    ...
    <li>
        <div class="collapsible-header"><i class="material-icons">assignment_ind</i>Sócio 2</div>
        <div class="collapsible-body">
            <p>Nome: <?= $nome = "ana" ?></p>
            <p>Sexo: <?= $sexo = "feminino" ?></p>
            <p>Idade: <?= $idade = "45" ?></p>
            <p>Obito: <?= $obito = "não" ?></p>
            <p>Nome da mãe: <?= $nomeMae = "joana" ?></p>
            <p>Cpf da mãe: <?= $cpfMae = "354454" ?></p>
        </div>
    </li>
    <li>
